...
const navigation = [
  ...
  { name: "Products", link: "/admin", admin: true, current: false },
                  ...
                  <div className="flex justify-between px-5">
                    ...
                    <div className="flex items-center">
                      <Link to="/cart">
                        <button
                          type="button"
                          className="static ml-auto flex-shrink-0 rounded-full bg-gray-800 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                          <span className="absolute -inset-1.5" />
                          <ShoppingCartIcon className="h-6 w-6" aria-hidden="true" />
                        </button>
                      </Link>
