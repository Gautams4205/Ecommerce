...
import { ChevronLeftIcon, StarIcon, ChevronRightIcon } from "@heroicons/react/20/solid";
                ...
                <div className="lg:col-span-3">
                  <div>
                    <Link
                      ...
                      className="rounded-md mx-10 my-2 bg-green-600 px-1 py-1 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">
                      Add New Product
                    </Link>
                  </div>
                  {/* Product grid */}
              ...
              <div key={product.id}>
                <Link to={`/admin/product-detail/${product.id}`}>
                  <div className="group relative border-solid border-2 p-1 border-gray-200">
                    ...
                    {product.deleted && <div className="text-sm text-red-400">Product Deleted</div>}
                  </div>
                </Link>
...
function Pagenation({ Page, handlePage, totalItems }) {
